...
class DeliveryLocation
{
     ...
     */
    #[ORM\OneToMany(targetEntity: Shipment::class, mappedBy: 'deliveryLocation')]
    ...
    public function addShipment(Shipment $shipment): static
    {
        if (!$this->shipments->contains($shipment)) {
            ...
            $shipment->setDeliveryLocation($this);
        }
    ...
    public function removeShipment(Shipment $shipment): static
    {
        if ($this->shipments->removeElement($shipment)) {
            ...
            if ($shipment->getDeliveryLocation() === $this) {
                $shipment->setDeliveryLocation(null);
            }
        }
